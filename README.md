...
[renovate]: https://github.com/renovatebot/renovate/releases/tag/36.20.1 'Renovate release'
...
```json
{
  "extends": ["github>bfra-me/renovate-config#v1.13.1"]
}
```
...
```yaml
- name: Renovate
  uses: bfra-me/renovate-config/.github/workflows/renovate.yaml@v1.13.1
  with:
    dry_run: false
