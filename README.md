...
[renovate]: https://github.com/renovatebot/renovate/releases/tag/36.25.5 'Renovate release'
...
```json
{
  "extends": ["github>bfra-me/renovate-config#v1.16.0"]
}
```
...
```yaml
- name: Renovate
  uses: bfra-me/renovate-config/.github/workflows/renovate.yaml@v1.16.0
  with:
    dry_run: false
